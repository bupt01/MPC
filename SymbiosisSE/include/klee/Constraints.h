...
public:
  std::vector<int> prefixNum;
  std::vector< ref<Expr> > constraints1;
  ...
  ref<Expr> simplifyExpr1(ref<Expr> e) const;

  void addConstraint(ref<Expr> e);
  void addConstraint1(ref<Expr> e, std::pair<int, int> index);
...
private:
  ...
  bool rewriteConstraints1(ExprVisitor &visitor);

  void addConstraintInternal(ref<Expr> e);
  void addConstraintInternal1(ref<Expr> e, std::pair<int, int> index);
};
