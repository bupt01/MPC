...
int line_f  = 0;
int maxlen  = 64;
// ANDI this variable is not used globally, so I make it local
//int ignore_case = 0;
     ...
     char *argv[])
{
  ...
  EndOptions:
    ...
    //niloo
    do_ftw("../../simple/pthreads1.c");
    do_ftw("../../simple/pthreads2.c");
    do_ftw("../../simple/pthreads3.c");
    do_ftw("../../simple/pthreads4.c");
    //do_ftw("../pthreads5.c");
    //do_ftw("../pthreads6.c");
    //do_ftw("../pthreads7.c");
    //do_ftw("../pthreads8.c");
