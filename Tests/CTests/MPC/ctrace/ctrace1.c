...
int foo(void *arg)
{
    ...
    for(i=n; i>0; i--){
	    //sleep(1);
        TRC_PRINT(UNIT_FOO, TRC1, ("Hello world[%d]", i));
    }
...
int main(int argc, char **argv)
{
	...
	//CREST_shared_uint(_on);
	//CREST_shared_uint(_tlevel);
	//CREST_shared_uint(_server);
	CREST_shared_int(_msgs);
	CREST_shared_int(_serv_sockfd);
	CREST_shared_int(_initialised);
