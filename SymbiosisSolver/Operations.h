...
class Operation {
    ...
    virtual std::string getOrderConstraintName2();
    virtual void print();
...
class CallOperation : public Operation{
    ...
    std::string getOrderConstraintName2();
    void print();
...
class RWOperation : public Operation{
    ...
    std::string getInitialValueName2();  //for a given read, returns the symbolic name of the initial value
